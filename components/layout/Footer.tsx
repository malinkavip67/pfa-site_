...
export default function Footer() {
  return <footer className="border-t border-white/10 py-16"><Container className="grid grid-cols-2 gap-12 max-md:grid-cols-1">
    <div><Image src="/images/logo/logo-white.jpg" width={1366} height={768} className="h-auto w-56 object-contain" alt="Premier Football Agency" /><p className="mt-4 text-xs text-slate-500">Строим карьеру чемпионов.</p></div>
