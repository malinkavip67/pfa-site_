...
export default function Hero() {
  ...
  return <section id="top" className="relative isolate flex min-h-screen items-center overflow-hidden">
    <motion.div className="absolute -inset-y-24 inset-x-0 z-0 will-change-transform" style={{ y: imageY }}><Image src="/images/hero/hero-stadium.png" fill priority sizes="100vw" className="object-cover" alt="Ночной футбольный стадион" /></motion.div>
